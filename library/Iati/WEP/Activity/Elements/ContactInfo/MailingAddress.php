<?php
class Iati_WEP_Activity_Elements_ContactInfo_MailingAddress extends
                                    Iati_WEP_Activity_Elements_ContactInfo
{
    ...
    protected $attributes_html = array(
                ...
                'text' => array(
                    'name' => 'text',
                    'label' => 'Address',
                    'html' => '<textarea rows="2" cols="20" name="%(name)s %(attrs)s">%(value)s</textarea><div class="help contact_info-mailing_address-text"></div>',
