<?php
class Iati_WEP_Activity_Elements_Status extends Iati_WEP_Activity_Elements_ElementBase
{
    protected $text = '';
    protected $code = '';
    protected $xml_lang;
    ...
    public function __construct($id = 0)
    {
        ...
        $this->html = array(
                        ...
                        'code' => '<dt><label for="">%s</label><dt><dd><select name="%s">%s</select></dd>',
...
//        $this->setAccountActivity($accountActivity);
    ...
    public function setHtml()
    {
        ...
        $this->html['code'] = sprintf($this->html['code'], 'Activity Status Code', $this->decorateName('code'), $this->createOptionHtml('code'));
    ...
    public function setAll($id = 0)
    {
        ...
        $this->options['code'] = $model->getCodearray('Status', null, '1');
