...
class Iati_WEP_Activity_Elements_Result_Indicator_Title extends Iati_WEP_Activity_Elements_Transaction
{
    ...
    protected $attributes_html = array(
                ...
                'text' => array(
                    ...
                    'name' => 'text',
                    'label' => 'Text',
                    'html' => '<input type="text" name="%(name)s" %(attrs)s value= "%(value)s" /><div class="help result-indicator-title-text"></div>',
                    'attrs' => array('class' => array('form-text'))
                ),
                'xml_lang' => array(
                    'name' => 'xml_lang',
                    'label' => 'Language',
                    'html' => '<select name="%(name)s" %(attrs)s>%(options)s</select><div class="help result-indicator-title-xml_lang"></div>',
                    'options' => '',
