...
class Iati_WEP_Activity_Elements_Transaction_AidType extends Iati_WEP_Activity_Elements_Transaction
{
    ...
    protected $attributes_html = array(
                ...
                'text' => array(
                    'name' => 'text',
                    'label' => 'Text',
                    'html' => '<textarea rows="2" cols="20" name="%(name)s" %(attrs)s>%(value)s</textarea><div class="help transaction-aid_type-text"></div>',
                    'attrs' => array('class' => array('form-text'))
                ),
                'code' => array(
                    'name' => 'code',
                    'label' => 'Aid Type Code',
                    'html' => '<select name="%(name)s" %(attrs)s>%(options)s</select><div class="help transaction-aid_type-code"></div>',
                    'options' => '',
                ...
                'xml_lang' => array(
                    'name' => 'xml_lang',
                    'label' => 'Language',
                    'html' => '<select name="%(name)s" %(attrs)s>%(options)s</select><div class="help transaction-aid_type-xml_lang"></div>',
                    'options' => '',
                    'attrs' => array('class' => array('form-select'))
                ),
    );
