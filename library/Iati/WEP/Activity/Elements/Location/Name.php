<?php 
class Iati_WEP_Activity_Elements_Location_Name extends Iati_WEP_Activity_Elements_Location
{
    ...
    protected $attributes_html = array(
                ...
                'text' => array(
                    ...
                    'name' => 'text',
                    'label' => 'Text',
                    'html' => '<textarea rows="2" cols="20" name="%(name)s" %(attrs)s>%(value)s</textarea><div class="help location-name-text"></div>',
                    'attrs' => array('class' => array('form-text'))
                ),
                'xml_lang' => array(
                    'name' => 'xml_lang',
                    'label' => 'Language',
                    'html' => '<select name="%(name)s" %(attrs)s>%(options)s</select><div class="help location-name-xml_lang"></div>',
                    'options' => '',
