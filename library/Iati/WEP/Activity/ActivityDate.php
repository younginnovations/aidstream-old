...
class Iati_WEP_Activity_ActivityDate extends Iati_WEP_Activity_ElementBase
{
    ...
    public function __construct($id = 0)
    {
        ...
        $this->objectName = 'ActivityDate';
        $this->tableName = 'iati_activity_date';
        $this->html = array(
...
//        $this->setProperties();
    ...
    public function checkPrivilege()
    {
        ...
        if (!Zend_Registry::get('acl')->isAllowed($userRole, $resource, 'ActivityDate')) {
