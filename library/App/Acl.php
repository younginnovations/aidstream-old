...
//        this allows the role user to use user module's user controller's logout action
        ...
        $this->allow('user', 'default:activity', 'add-element', new App_ActionAssertion('add_activity_elements'));
        $this->allow('user', 'default:activity', 'list-elements', new App_ActionAssertion('edit_activity_elements'));
        $this->allow('user', 'default:activity', 'edit-element', new App_ActionAssertion('edit_activity_elements'));
        $this->allow('user', 'default:activity', 'delete-element', new App_ActionAssertion('delete_activity'));
        $this->allow('user', 'default:activity', 'delete-elements', new App_ActionAssertion('delete_activity'));
        $this->allow('user', 'default:activity', 'view-element', new App_ActionAssertion('edit_activity_elements'));
        $this->allow('user', 'default:activity', 'view-activity-info');
        $this->allow('user', 'default:activity', 'duplicate-activity', new App_ActionAssertion('add_activity'));
        $this->allow('user', 'default:activity', 'delete-activity', new App_ActionAssertion('delete_activity'));
        ...
        $this->allow('user', 'default:wep', 'delete-activity');
        ...
        $this->allow('user', 'default:wep', 'list-published-files', new App_ActionAssertion('publish'));
        $this->allow('user', 'default:organisation', 'add-elements', new App_ActionAssertion('add_activity_elements'));
        $this->allow('user', 'default:organisation', 'edit-elements', new App_ActionAssertion('edit_activity_elements'));
        ...
        $this->allow('admin', 'default:wep', 'list-published-files');
        $this->allow('admin', 'default:activity', 'add-element');
        $this->allow('admin', 'default:activity', 'list-elements');
        $this->allow('admin', 'default:activity', 'edit-element');
        $this->allow('admin', 'default:activity', 'delete-element');
        $this->allow('admin', 'default:activity', 'delete-elements');
        $this->allow('admin', 'default:activity', 'view-element');
        $this->allow('admin', 'default:activity', 'duplicate-activity');
        $this->allow('admin', 'default:activity', 'delete-activity');
        $this->allow('admin', 'default:organisation', 'add-elements');
        $this->allow('admin', 'default:organisation', 'edit-elements');
