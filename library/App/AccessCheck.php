...
class App_AccessCheck extends Zend_Controller_Plugin_Abstract
{
    ...
    public function preDispatch(Zend_Controller_Request_Abstract $request)
    {
        ...
        //getting the role from the registry and defining some role for the null
        //character as guest makes authentication more flexible
        //if the roles is not allowed to use the resource then the user is
        // redirected to action login of controller user
