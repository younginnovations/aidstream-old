        ...
        "select.vocabulary_value": {
            "found": function (ele) {
                ...
                if (ele.value == 8) {
                    ...
                    dojo.query('.dac_three_code', formWrapper).parent().style('display', 'block');
                } else if (ele.value == '' || ele.value == 3) {
                    dojo.query('.non_dac_code', formWrapper).attr('value', '');
                    dojo.query('.non_dac_code', formWrapper).parent().style('display', 'none');
                    dojo.query('.dac_three_code', formWrapper).attr('value', '');
                    dojo.query('.dac_three_code', formWrapper).parent().style('display', 'none');
            ...
            "onchange": function (evt) {
                ...
                if (selected.value == 8) {
                    ...
                    dojo.query('.sector_value', formWrapper).parent().style('display', 'none');
                    dojo.query('.dac_three_code', formWrapper).parent().style('display', 'block');
                } else if (selected.value == '' || selected.value == 3) {
                    dojo.query('.non_dac_code', formWrapper).attr('value', '');
                    dojo.query('.non_dac_code', formWrapper).parent().style('display', 'none');
                    dojo.query('.dac_three_code', formWrapper).attr('value', '');
                    dojo.query('.dac_three_code', formWrapper).parent().style('display', 'none');
